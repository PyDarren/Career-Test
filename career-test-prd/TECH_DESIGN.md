...
- [Django 项目结构](#project-structure)
- [后端 API 设计](#api-design)
- [前端架构](#frontend-architecture)
- [核心业务逻辑](#business-logic)
- [支付系统设计](#payment-system)
- [缓存策略](#cache-strategy)
- [部署架构](#deployment)
- [安全设计](#security)
- [监控与告警](#monitoring)
- [关键技术点](#key-tech-points)
- [支撑系统设计](#support-system)
